...
function hslToRgb(hue, saturation, lightness) {
  ...
  const x = c * (1 - Math.abs((normalizedHue * 6) % 2 - 1));
  ...
  } else if (normalizedHue < 2 / 6) {
    red = x; green = c; blue = 0;
  } else if (normalizedHue < 3 / 6) {
    red = 0; green = c; blue = x;
  } else if (normalizedHue < 4 / 6) {
    red = 0; green = x; blue = c;
  } else if (normalizedHue < 5 / 6) {
...
function oklchToSrgb(lightness, chroma, hue) {
  return linearRgbToSrgb(oklchToLinearSrgb(lightness, chroma, hue));
}
...
function hptToSrgb(hue, lightness, temperature) {
  const temperatureRgb = paintTemperatureToRgb(temperature);
  const temperatureLinear = rgbToLinearRgb(temperatureRgb);
  const hueLinear = rgbToLinearRgb(hslToRgb(hue, 0.9, lightness));
  const mix = 0.22 + (lightness - 0.32) * 0.08;

  return linearRgbToSrgb(mixLinearRgb(temperatureLinear, hueLinear, clamp(mix, 0.18, 0.32)));
}
const colorConditions = [
  { key: "magenta-redorange-light", label: "Magenta-RedOrangeLight", hueLabel: "Magenta-RedOrange", lightnessLabel: "Light", hue: 330, lightness: 0.78 },
  { key: "blue-green-light", label: "Blue-GreenLight", hueLabel: "Blue-Green", lightnessLabel: "Light", hue: 190, lightness: 0.78 },
  { key: "blue-yellow-light", label: "Blue-YellowLight", hueLabel: "Blue-Yellow", lightnessLabel: "Light", hue: 55, lightness: 0.78 },
  { key: "magenta-redorange-normal", label: "Magenta-RedOrangeNormal", hueLabel: "Magenta-RedOrange", lightnessLabel: "Normal", hue: 330, lightness: 0.54 },
  { key: "blue-green-normal", label: "Blue-GreenNormal", hueLabel: "Blue-Green", lightnessLabel: "Normal", hue: 190, lightness: 0.54 },
  { key: "blue-yellow-normal", label: "Blue-YellowNormal", hueLabel: "Blue-Yellow", lightnessLabel: "Normal", hue: 55, lightness: 0.54 },
  { key: "magenta-redorange-dark", label: "Magenta-RedOrangeDark", hueLabel: "Magenta-RedOrange", lightnessLabel: "Dark", hue: 330, lightness: 0.32 },
  { key: "blue-green-dark", label: "Blue-GreenDark", hueLabel: "Blue-Green", lightnessLabel: "Dark", hue: 190, lightness: 0.32 },
  { key: "blue-yellow-dark", label: "Blue-YellowDark", hueLabel: "Blue-Yellow", lightnessLabel: "Dark", hue: 55, lightness: 0.32 },
];
...
const shapeGroups = {
  spiky: {
    ...
    label: "Spikey",
    svgs: [
      `<svg version="1.1" viewBox="0.0 0.0 960.0 720.0" fill="none" stroke="none" stroke-linecap="square" stroke-miterlimit="10" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg"><clipPath id="p.0"><path d="m0 0l960.0 0l0 720.0l-960.0 0l0 -720.0z" clip-rule="nonzero"/></clipPath><g clip-path="url(#p.0)"><path fill="#000000" fill-opacity="0.0" d="m0 0l960.0 0l0 720.0l-960.0 0z" fill-rule="evenodd"/><path fill="#000000" fill-opacity="0.0" d="m193.50131 625.51447l312.75592 -534.6142l312.7559 534.6142z" fill-rule="evenodd"/><path stroke="#000000" stroke-width="1.0" stroke-linejoin="round" stroke-linecap="butt" d="m193.50131 625.51447l312.75592 -534.6142l312.7559 534.6142z" fill-rule="evenodd"/></g></svg>`,
      `<svg version="1.1" viewBox="0.0 0.0 960.0 720.0" fill="none" stroke="none" stroke-linecap="square" stroke-miterlimit="10" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg"><clipPath id="p.0"><path d="m0 0l960.0 0l0 720.0l-960.0 0l0 -720.0z" clip-rule="nonzero"/></clipPath><g clip-path="url(#p.0)"><path fill="#000000" fill-opacity="0.0" d="m0 0l960.0 0l0 720.0l-960.0 0z" fill-rule="evenodd"/><path fill="#000000" fill-opacity="0.0" d="m171.0 613.80054l0 -546.2992l720.9134 546.2992z" fill-rule="evenodd"/><path stroke="#000000" stroke-width="1.0" stroke-linejoin="round" stroke-linecap="butt" d="m171.0 613.80054l0 -546.2992l720.9134 546.2992z" fill-rule="evenodd"/></g></svg>`,
      `<svg version="1.1" viewBox="0.0 0.0 960.0 720.0" fill="none" stroke="none" stroke-linecap="square" stroke-miterlimit="10" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg"><clipPath id="p.0"><path d="m0 0l960.0 0l0 720.0l-960.0 0l0 -720.0z" clip-rule="nonzero"/></clipPath><g clip-path="url(#p.0)"><path fill="#000000" fill-opacity="0.0" d="m0 0l960.0 0l0 720.0l-960.0 0z" fill-rule="evenodd"/><path fill="#000000" fill-opacity="0.0" d="m130.50131 642.5932l147.59842 -590.39374l560.71655 0l-147.59845 590.39374z" fill-rule="evenodd"/><path stroke="#000000" stroke-width="1.0" stroke-linejoin="round" stroke-linecap="butt" d="m130.50131 642.5932l147.59842 -590.39374l560.71655 0l-147.59845 590.39374z" fill-rule="evenodd"/></g></svg>`,
      `<svg version="1.1" viewBox="0.0 0.0 960.0 720.0" fill="none" stroke="none" stroke-linecap="square" stroke-miterlimit="10" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg"><clipPath id="p.0"><path d="m0 0l960.0 0l0 720.0l-960.0 0l0 -720.0z" clip-rule="nonzero"/></clipPath><g clip-path="url(#p.0)"><path fill="#000000" fill-opacity="0.0" d="m0 0l960.0 0l0 720.0l-960.0 0z" fill-rule="evenodd"/><path fill="#000000" fill-opacity="0.0" d="m234.0 327.60367l244.34647 -268.2047l244.34647 268.2047l-244.34647 268.20474z" fill-rule="evenodd"/><path stroke="#000000" stroke-width="1.0" stroke-linejoin="round" stroke-linecap="butt" d="m234.0 327.60367l244.34647 -268.2047l244.34647 268.2047l-244.34647 268.20474z" fill-rule="evenodd"/></g></svg>`,
      `<svg version="1.1" viewBox="0.0 0.0 960.0 720.0" fill="none" stroke="none" stroke-linecap="square" stroke-miterlimit="10" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg"><clipPath id="p.0"><path d="m0 0l960.0 0l0 720.0l-960.0 0l0 -720.0z" clip-rule="nonzero"/></clipPath><g clip-path="url(#p.0)"><path fill="#000000" fill-opacity="0.0" d="m0 0l960.0 0l0 720.0l-960.0 0z" fill-rule="evenodd"/><path fill="#000000" fill-opacity="0.0" d="m318.45703 291.05643l161.54297 -223.10367l161.54297 223.10367l-61.70392 360.98935l-199.6781 0z" fill-rule="evenodd"/><path stroke="#000000" stroke-width="1.0" stroke-linejoin="round" stroke-linecap="butt" d="m318.45703 291.05643l161.54297 -223.10367l161.54297 223.10367l-61.70392 360.98935l-199.6781 0z" fill-rule="evenodd"/></g></svg>`,
      `<svg version="1.1" viewBox="0.0 0.0 960.0 720.0" fill="none" stroke="none" stroke-linecap="square" stroke-miterlimit="10" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg"
      `<svg version="1.1" viewBox="0.0 0.0 960.0 720.0" fill="none" stroke="none" stroke-linecap="square" stroke-miterlimit="10" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg"><clipPath id="p.0"><path d="m0 0l960.0 0l0 720.0l-960.0 0l0 -720.0z" clip-rule="nonzero"/></clipPath><g clip-path="url(#p.0)"><path fill="#000000" fill-opacity="0.0" d="m0 0l960.0 0l0 720.0l-960.0 0z" fill-rule="evenodd"/><path fill="#ffffff" d="m263.70078 310.4987l-20.700775 -37.797913l-162.90027 -223.19946l369.0 278.99738l-94.49869 -259.19946l170.09976 285.30182l360.90027 -262.80054l-257.4016 368.09973l293.4016 162.0l-407.7008 -61.199463l-192.60104 86.398926l208.8005 -202.49869l-324.0 63.0l75.60104 -117.90027l-189.90025 -10.800507z" fill-rule="evenodd"/><path stroke="#000000" stroke-width="1.0" stroke-linejoin="round" stroke-linecap="butt" d="m263.70078 310.4987l-20.700775 -37.797913l-162.90027 -223.19946l369.0 278.99738l-94.49869 -259.19946l170.09976 285.30182l360.90027 -262.80054l-257.4016 368.09973l293.4016 162.0l-407.7008 -61.199463l-192.60104 86.398926l208.8005 -202.49869l-324.0 63.0l75.60104 -117.90027l-189.90025 -10.800507z" fill-rule="evenodd"/></g></svg>`,
    ],
  },
  rounded: {
    key: "rounded",
...
const elements = {
  shapeLabel: document.getElementById("shape-label") || { textContent: "" },
...
function buildTrials() {
  ...
  for (const shapeGroup of shapeGroupsInUse) {
    ...
    const shuffledConditions = shuffleArray(colorConditions);

    shuffledConditions.forEach((condition, index) => {
      trials.push({
        id: `${shapeGroup.key}-${condition.key}`,
        shapeKey: shapeGroup.key,
        shapeLabel: shapeGroup.label,
        conditionKey: condition.key,
        conditionLabel: condition.label,
        hue: condition.hue,
        hueLabel: condition.hueLabel,
        lightness: condition.lightness,
        lightnessLabel: condition.lightnessLabel,
        temperature: defaultTemperature,
        renderColor: hptToSrgb(condition.hue, condition.lightness, defaultTemperature),
        svgMarkup: shuffledSvgs[index % shuffledSvgs.length],
      });
    });
  }
...
function colorizeSvg(svgElement, labColor) {
  svgElement.style.color = labColor;

  svgElement.querySelectorAll("g path, g polygon, g rect, g circle, g ellipse, g polyline").forEach((element) => {
    const fill = element.getAttribute("fill");
    const fillOpacity = element.getAttribute("fill-opacity");

    if (fill !== "none" && fillOpacity !== "0.0") {
...
function updateTrialView() {
  ...
  trial.renderColor = hptToSrgb(trial.hue, trial.lightness, currentTemperature);
...
function saveCurrentResponse() {
  ...
  trial.renderColor = hptToSrgb(trial.hue, trial.lightness, response);
...
elements.temperatureSlider.addEventListener("input", () => {
  ...
  trial.renderColor = hptToSrgb(trial.hue, trial.lightness, value);
